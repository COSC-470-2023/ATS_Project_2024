...
var constituentItems = ['Constituent 1', 'Constituent 2', 'Constituent 3', 'Constituent 4', 'Constituent 5'];
var dataSourceItems = ['Data Source 1', 'Data Source 2', 'Data Source 3', 'Data Source 4', 'Data Source 5'];
...
function updateAddModalBody(list) {
  ...
  list.forEach(function(item) {
    ...
    var checkbox = $('<input>').attr('type', 'checkbox').addClass('config-item-checkbox'); // Create checkbox
...
function addSelectedItemsToConfigList(targetListId) {
  var checkedItems = $('.modal-body .modal-list ul .config-item-checkbox:checked').closest('li'); // Get checked items
...
function updateRemoveModalBody(targetListId) {
  ...
  targetList.find('li').each(function(index) {
    ...
    if (index !== 0) {
      ...
      var checkbox = $('<input>').attr('type', 'checkbox').addClass('remove-item-checkbox'); // Create a checkbox
