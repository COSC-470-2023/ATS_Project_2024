...
from ats.collection import symbol_change_query
...
class TestSymbolChangeQueryMethods(unittest.TestCase):
    ...
    def test_trim_query_output(self):
    ...
    def test_get_old_name(self):
        ...
        self.assertEqual(test_name, success_output)
        self.assertEqual("", fail_output)
    
    def test_modify_output_list(self):
        date = '3034-01-31'
    ...
    def test_modify_system_config(self):
