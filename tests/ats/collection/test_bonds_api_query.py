...
class BondsApiQueryTestCase(unittest.TestCase):
    date_test = bonds_api_query.create_date_window
    query_test = bonds_api_query.make_queries

    # Test creating date objects, checking to see if it returns a non-empty list. 
    def test_create_date(self):
        date_list = bonds_api_query.create_date_window(123)
    ...
    def test_make_queries(self, mock_get):
        ...
        api_key = "api_key"
        api_fields = {'_bond_name': 'Name', '_bond_date': 'date', '_bond_month1': 'one', '_bond_month2': 'two',
                      '_bond_month3': 'three', '_bond_month6': 'six', '_bond_year1': 'y1', '_bond_year2': 'y2',
                      '_bond_year3': 'y3', '_bond_year5': 'y5', '_bond_year7': 'y7', '_bond_year10': 'y10',
                      '_bond_year20': 'y20', '_bond_year30': 'y30'}
        ...
        bonds_list = bonds_api_query.make_queries(api_url, api_key, api_fields, treasuries, non_api_fields, days_queried)
        # Tests 
