...
from data_collection.collection import constituent_api_query


class ConfigLoadTestCase(unittest.TestCase):
    json_config = constituent_api_query.load_config()

    def test_url(self):
        expected_url = "https://financialmodelingprep.com/api/v3/{QUERY_PARAMS}?apikey={API_KEY}"
