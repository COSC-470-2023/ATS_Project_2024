...
from data_collection.collection import company_info_api_query


class ConfigLoadTestCase(unittest.TestCase):
    json_config = company_info_api_query.load_config()

    def test_url(self):
        expected_url = "https://financialmodelingprep.com/api/v3/profile/{QUERY_PARAMS}?apikey={API_KEY}"
