...
from data_collection.collection import symbol_change_query


class ConfigLoadTestCase(unittest.TestCase):
    json_config = symbol_change_query.load_config()

    def test_url(self):
        expected_url = "https://financialmodelingprep.com/api/v4/symbol_change?apikey={API_KEY}"
