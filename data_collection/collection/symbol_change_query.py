...
##########################################################################
# FILE/PATH VARIABLES
SYSTEM_CONFIG_PATH_LIST = ["./data_collection/configuration/realtime_query_cfg.json", 
                            "./data_collection/configuration/company_info_query_cfg.json",
                            "./data_collection/configuration/historical_query_cfg.json"]
CONFIG_PATH = "./data_collection/configuration/"
CONFIG_BACKUP_PATH = "./data_collection/configuration/backup/"
QUERY_CONFIG_PATH = "./data_collection/configuration/symbol_change_query_cfg.json"
OUTPUT_PATH = "./data_collection/output/"
